...
/**
 * The class for the Base Managed App Registration.
 */
public class BaseManagedAppRegistration extends Entity implements IJsonBackedObject {
    ...
    public void setRawObject(final ISerializer serializer, final JsonObject json) {
        ...
        if (json.has("operations")) {
            final BaseManagedAppOperationCollectionResponse response = new BaseManagedAppOperationCollectionResponse();
