...
/**
 * The class for the Base Windows10General Configuration Request Builder.
 */
public class BaseWindows10GeneralConfigurationRequestBuilder extends BaseRequestBuilder implements IBaseWindows10GeneralConfigurationRequestBuilder {
     ...
     */
    public BaseWindows10GeneralConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
