...
/**
 * The class for the Base Device Compliance Scheduled Action For Rule Collection Request Builder.
 */
public class BaseDeviceComplianceScheduledActionForRuleCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDeviceComplianceScheduledActionForRuleCollectionRequestBuilder {
     ...
     */
    public BaseDeviceComplianceScheduledActionForRuleCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IDeviceComplianceScheduledActionForRuleCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IDeviceComplianceScheduledActionForRuleCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
