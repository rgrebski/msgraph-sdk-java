...
/**
 * The class for the Base Ios Custom Configuration Request.
 */
public class BaseIosCustomConfigurationRequest extends BaseRequest implements IBaseIosCustomConfigurationRequest {
     ...
     */
    public BaseIosCustomConfigurationRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<IosCustomConfiguration> responseClass) {
