...
/**
 * The interface for the Base Managed Device Overview Reference Request.
 */
public interface IBaseManagedDeviceOverviewReferenceRequest extends IHttpRequest {
     ...
     */
    IBaseManagedDeviceOverviewReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseManagedDeviceOverviewReferenceRequest expand(final String value);
