...
/**
 * The interface for the Base Mobile Threat Defense Connector Request Builder.
 */
public interface IBaseMobileThreatDefenseConnectorRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
