...
/**
 * The class for the Base Mdm Windows Information Protection Policy Collection Request.
 */
public class BaseMdmWindowsInformationProtectionPolicyCollectionRequest extends BaseCollectionRequest<BaseMdmWindowsInformationProtectionPolicyCollectionResponse, IMdmWindowsInformationProtectionPolicyCollectionPage> implements IBaseMdmWindowsInformationProtectionPolicyCollectionRequest {
     ...
     */
    public BaseMdmWindowsInformationProtectionPolicyCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseMdmWindowsInformationProtectionPolicyCollectionResponse.class, IMdmWindowsInformationProtectionPolicyCollectionPage.class);
    }
    ...
    public IMdmWindowsInformationProtectionPolicyCollectionPage get() throws ClientException {
        final BaseMdmWindowsInformationProtectionPolicyCollectionResponse response = send();
    ...
    public IMdmWindowsInformationProtectionPolicyCollectionPage buildFromResponse(final BaseMdmWindowsInformationProtectionPolicyCollectionResponse response) {
