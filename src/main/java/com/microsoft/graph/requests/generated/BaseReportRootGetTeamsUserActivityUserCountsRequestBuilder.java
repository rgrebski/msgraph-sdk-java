...
public class BaseReportRootGetTeamsUserActivityUserCountsRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseReportRootGetTeamsUserActivityUserCountsRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
     ...
     * @return the IReportRootGetTeamsUserActivityUserCountsRequest instance
     */
    public IReportRootGetTeamsUserActivityUserCountsRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
