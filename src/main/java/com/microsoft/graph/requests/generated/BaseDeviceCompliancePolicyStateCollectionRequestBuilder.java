...
/**
 * The class for the Base Device Compliance Policy State Collection Request Builder.
 */
public class BaseDeviceCompliancePolicyStateCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDeviceCompliancePolicyStateCollectionRequestBuilder {
     ...
     */
    public BaseDeviceCompliancePolicyStateCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
