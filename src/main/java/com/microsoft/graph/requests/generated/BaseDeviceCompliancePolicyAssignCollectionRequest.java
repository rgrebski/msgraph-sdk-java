...
import com.microsoft.graph.requests.extensions.IDeviceCompliancePolicyAssignCollectionPage;
...
/**
 * The class for the Base Device Compliance Policy Assign Collection Request.
 */
public class BaseDeviceCompliancePolicyAssignCollectionRequest extends BaseCollectionRequest<BaseDeviceCompliancePolicyAssignCollectionResponse, IDeviceCompliancePolicyAssignCollectionPage> implements IBaseDeviceCompliancePolicyAssignCollectionRequest {
     ...
     */
    public BaseDeviceCompliancePolicyAssignCollectionRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseDeviceCompliancePolicyAssignCollectionResponse.class, IDeviceCompliancePolicyAssignCollectionPage.class);
    ...
    public IDeviceCompliancePolicyAssignCollectionPage post() throws ClientException {
        final BaseDeviceCompliancePolicyAssignCollectionResponse response = post(body);
        return buildFromResponse(response);
    }


    public IDeviceCompliancePolicyAssignCollectionPage buildFromResponse(final BaseDeviceCompliancePolicyAssignCollectionResponse response) {
