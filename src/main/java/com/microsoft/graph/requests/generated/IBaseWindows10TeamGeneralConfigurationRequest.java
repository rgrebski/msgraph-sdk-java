...
/**
 * The interface for the Base Windows10Team General Configuration Request.
 */
public interface IBaseWindows10TeamGeneralConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseWindows10TeamGeneralConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseWindows10TeamGeneralConfigurationRequest expand(final String value);
