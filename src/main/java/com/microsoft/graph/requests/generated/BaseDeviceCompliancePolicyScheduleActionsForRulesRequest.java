...
/**
 * The class for the Base Device Compliance Policy Schedule Actions For Rules Request.
 */
public class BaseDeviceCompliancePolicyScheduleActionsForRulesRequest extends BaseRequest implements IBaseDeviceCompliancePolicyScheduleActionsForRulesRequest {
     ...
     */
    public BaseDeviceCompliancePolicyScheduleActionsForRulesRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
