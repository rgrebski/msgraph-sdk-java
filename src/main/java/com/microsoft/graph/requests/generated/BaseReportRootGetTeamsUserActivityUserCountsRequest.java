...
public class BaseReportRootGetTeamsUserActivityUserCountsRequest extends BaseRequest implements IBaseReportRootGetTeamsUserActivityUserCountsRequest {
     ...
     */
    public BaseReportRootGetTeamsUserActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
