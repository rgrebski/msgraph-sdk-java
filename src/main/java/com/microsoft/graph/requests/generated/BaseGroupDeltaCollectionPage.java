...
/**
 * The class for the Base Group Delta Collection Page.
 */
public class BaseGroupDeltaCollectionPage extends BaseCollectionPage<Group, IGroupDeltaCollectionRequestBuilder> implements IBaseGroupDeltaCollectionPage {
     ...
     */
    public BaseGroupDeltaCollectionPage(final BaseGroupDeltaCollectionResponse response, final IGroupDeltaCollectionRequestBuilder builder) {
