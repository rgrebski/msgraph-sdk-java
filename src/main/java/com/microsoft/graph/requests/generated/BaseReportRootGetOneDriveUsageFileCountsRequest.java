...
public class BaseReportRootGetOneDriveUsageFileCountsRequest extends BaseRequest implements IBaseReportRootGetOneDriveUsageFileCountsRequest {
     ...
     */
    public BaseReportRootGetOneDriveUsageFileCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
