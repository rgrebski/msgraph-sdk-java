...
/**
 * The class for the Base Managed App Policy Collection Request Builder.
 */
public class BaseManagedAppPolicyCollectionRequestBuilder extends BaseRequestBuilder implements IBaseManagedAppPolicyCollectionRequestBuilder {
     ...
     */
    public BaseManagedAppPolicyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IManagedAppPolicyCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IManagedAppPolicyCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
