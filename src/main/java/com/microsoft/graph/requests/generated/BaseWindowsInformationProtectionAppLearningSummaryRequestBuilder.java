...
/**
 * The class for the Base Windows Information Protection App Learning Summary Request Builder.
 */
public class BaseWindowsInformationProtectionAppLearningSummaryRequestBuilder extends BaseRequestBuilder implements IBaseWindowsInformationProtectionAppLearningSummaryRequestBuilder {
     ...
     */
    public BaseWindowsInformationProtectionAppLearningSummaryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWindowsInformationProtectionAppLearningSummaryRequest buildRequest() {
