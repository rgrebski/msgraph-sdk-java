...
/**
 * The class for the Base Role Assignment Collection Request.
 */
public class BaseRoleAssignmentCollectionRequest extends BaseCollectionRequest<BaseRoleAssignmentCollectionResponse, IRoleAssignmentCollectionPage> implements IBaseRoleAssignmentCollectionRequest {
     ...
     */
    public BaseRoleAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IRoleAssignmentCollectionPage get() throws ClientException {
        final BaseRoleAssignmentCollectionResponse response = send();
    ...
    public IRoleAssignmentCollectionPage buildFromResponse(final BaseRoleAssignmentCollectionResponse response) {
