...
/**
 * The class for the Base Managed IOSStore App Request Builder.
 */
public class BaseManagedIOSStoreAppRequestBuilder extends BaseRequestBuilder implements IBaseManagedIOSStoreAppRequestBuilder {
     ...
     */
    public BaseManagedIOSStoreAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
