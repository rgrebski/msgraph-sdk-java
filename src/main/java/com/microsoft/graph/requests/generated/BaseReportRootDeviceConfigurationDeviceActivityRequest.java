...
/**
 * The class for the Base Report Root Device Configuration Device Activity Request.
 */
public class BaseReportRootDeviceConfigurationDeviceActivityRequest extends BaseRequest implements IBaseReportRootDeviceConfigurationDeviceActivityRequest {
     ...
     */
    public BaseReportRootDeviceConfigurationDeviceActivityRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
