...
/**
 * The class for the Base Managed EBook Collection Request.
 */
public class BaseManagedEBookCollectionRequest extends BaseCollectionRequest<BaseManagedEBookCollectionResponse, IManagedEBookCollectionPage> implements IBaseManagedEBookCollectionRequest {
     ...
     */
    public BaseManagedEBookCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseManagedEBookCollectionResponse.class, IManagedEBookCollectionPage.class);
    }
    ...
    public IManagedEBookCollectionPage get() throws ClientException {
        final BaseManagedEBookCollectionResponse response = send();
    ...
    public IManagedEBookCollectionPage buildFromResponse(final BaseManagedEBookCollectionResponse response) {
