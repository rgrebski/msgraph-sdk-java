...
/**
 * The class for the Base Windows10Custom Configuration Request.
 */
public class BaseWindows10CustomConfigurationRequest extends BaseRequest implements IBaseWindows10CustomConfigurationRequest {
     ...
     */
    public BaseWindows10CustomConfigurationRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<Windows10CustomConfiguration> responseClass) {
