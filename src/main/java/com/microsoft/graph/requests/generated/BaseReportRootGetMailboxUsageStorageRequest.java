...
public class BaseReportRootGetMailboxUsageStorageRequest extends BaseRequest implements IBaseReportRootGetMailboxUsageStorageRequest {
     ...
     */
    public BaseReportRootGetMailboxUsageStorageRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
