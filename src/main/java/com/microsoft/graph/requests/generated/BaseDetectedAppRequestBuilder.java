...
/**
 * The class for the Base Detected App Request Builder.
 */
public class BaseDetectedAppRequestBuilder extends BaseRequestBuilder implements IBaseDetectedAppRequestBuilder {
     ...
     */
    public BaseDetectedAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
