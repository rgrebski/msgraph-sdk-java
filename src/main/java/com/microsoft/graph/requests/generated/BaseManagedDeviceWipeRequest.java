...
/**
 * The class for the Base Managed Device Wipe Request.
 */
public class BaseManagedDeviceWipeRequest extends BaseRequest implements IBaseManagedDeviceWipeRequest {
     ...
     */
    public BaseManagedDeviceWipeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
