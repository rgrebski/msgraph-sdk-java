...
/**
 * The class for the Base Mobile App Request.
 */
public class BaseMobileAppRequest extends BaseRequest implements IBaseMobileAppRequest {
     ...
     */
    public BaseMobileAppRequest(final String requestUrl,
