...
/**
 * The class for the Base Android Managed App Protection Collection Request Builder.
 */
public class BaseAndroidManagedAppProtectionCollectionRequestBuilder extends BaseRequestBuilder implements IBaseAndroidManagedAppProtectionCollectionRequestBuilder {
     ...
     */
    public BaseAndroidManagedAppProtectionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
