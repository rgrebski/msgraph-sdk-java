...
/**
 * The class for the Base Device Configuration Assignment Request Builder.
 */
public class BaseDeviceConfigurationAssignmentRequestBuilder extends BaseRequestBuilder implements IBaseDeviceConfigurationAssignmentRequestBuilder {
     ...
     */
    public BaseDeviceConfigurationAssignmentRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
