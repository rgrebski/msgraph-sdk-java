...
public class BaseBaseItemCollectionRequestBuilder extends BaseRequestBuilder implements IBaseBaseItemCollectionRequestBuilder {
     ...
     */
    public BaseBaseItemCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IBaseItemCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
