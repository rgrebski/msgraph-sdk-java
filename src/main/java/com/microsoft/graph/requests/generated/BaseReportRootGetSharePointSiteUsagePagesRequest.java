...
public class BaseReportRootGetSharePointSiteUsagePagesRequest extends BaseRequest implements IBaseReportRootGetSharePointSiteUsagePagesRequest {
     ...
     */
    public BaseReportRootGetSharePointSiteUsagePagesRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
