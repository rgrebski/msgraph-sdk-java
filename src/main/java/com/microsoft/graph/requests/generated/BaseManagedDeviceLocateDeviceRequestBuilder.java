...
/**
 * The class for the Base Managed Device Locate Device Request Builder.
 */
public class BaseManagedDeviceLocateDeviceRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseManagedDeviceLocateDeviceRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
