...
/**
 * The interface for the Base Resource Operation Request.
 */
public interface IBaseResourceOperationRequest extends IHttpRequest {
     ...
     */
    IBaseResourceOperationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseResourceOperationRequest expand(final String value);
