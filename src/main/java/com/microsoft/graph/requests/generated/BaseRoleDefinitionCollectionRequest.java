...
/**
 * The class for the Base Role Definition Collection Request.
 */
public class BaseRoleDefinitionCollectionRequest extends BaseCollectionRequest<BaseRoleDefinitionCollectionResponse, IRoleDefinitionCollectionPage> implements IBaseRoleDefinitionCollectionRequest {
     ...
     */
    public BaseRoleDefinitionCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseRoleDefinitionCollectionResponse.class, IRoleDefinitionCollectionPage.class);
    }
    ...
    public IRoleDefinitionCollectionPage get() throws ClientException {
        final BaseRoleDefinitionCollectionResponse response = send();
    ...
    public IRoleDefinitionCollectionPage buildFromResponse(final BaseRoleDefinitionCollectionResponse response) {
