...
/**
 * The class for the Base Managed Device Mobile App Configuration Collection Request.
 */
public class BaseManagedDeviceMobileAppConfigurationCollectionRequest extends BaseCollectionRequest<BaseManagedDeviceMobileAppConfigurationCollectionResponse, IManagedDeviceMobileAppConfigurationCollectionPage> implements IBaseManagedDeviceMobileAppConfigurationCollectionRequest {
     ...
     */
    public BaseManagedDeviceMobileAppConfigurationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IManagedDeviceMobileAppConfigurationCollectionPage get() throws ClientException {
        final BaseManagedDeviceMobileAppConfigurationCollectionResponse response = send();
    ...
    public IManagedDeviceMobileAppConfigurationCollectionPage buildFromResponse(final BaseManagedDeviceMobileAppConfigurationCollectionResponse response) {
