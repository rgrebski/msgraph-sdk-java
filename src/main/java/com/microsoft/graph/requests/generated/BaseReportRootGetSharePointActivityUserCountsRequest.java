...
public class BaseReportRootGetSharePointActivityUserCountsRequest extends BaseRequest implements IBaseReportRootGetSharePointActivityUserCountsRequest {
     ...
     */
    public BaseReportRootGetSharePointActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
