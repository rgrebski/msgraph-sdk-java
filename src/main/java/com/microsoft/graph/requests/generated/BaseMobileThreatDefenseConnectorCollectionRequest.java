...
/**
 * The class for the Base Mobile Threat Defense Connector Collection Request.
 */
public class BaseMobileThreatDefenseConnectorCollectionRequest extends BaseCollectionRequest<BaseMobileThreatDefenseConnectorCollectionResponse, IMobileThreatDefenseConnectorCollectionPage> implements IBaseMobileThreatDefenseConnectorCollectionRequest {
     ...
     */
    public BaseMobileThreatDefenseConnectorCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IMobileThreatDefenseConnectorCollectionPage get() throws ClientException {
        final BaseMobileThreatDefenseConnectorCollectionResponse response = send();
    ...
    public IMobileThreatDefenseConnectorCollectionPage buildFromResponse(final BaseMobileThreatDefenseConnectorCollectionResponse response) {
