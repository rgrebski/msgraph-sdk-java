...
/**
 * The interface for the Base Mobile App Content File Request.
 */
public interface IBaseMobileAppContentFileRequest extends IHttpRequest {
     ...
     */
    IBaseMobileAppContentFileRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseMobileAppContentFileRequest expand(final String value);
