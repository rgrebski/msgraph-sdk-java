...
/**
 * The class for the Base Mac OSDevice Features Configuration Request Builder.
 */
public class BaseMacOSDeviceFeaturesConfigurationRequestBuilder extends BaseRequestBuilder implements IBaseMacOSDeviceFeaturesConfigurationRequestBuilder {
     ...
     */
    public BaseMacOSDeviceFeaturesConfigurationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IMacOSDeviceFeaturesConfigurationRequest buildRequest() {
