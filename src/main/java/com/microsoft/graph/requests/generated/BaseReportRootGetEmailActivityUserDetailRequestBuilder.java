...
public class BaseReportRootGetEmailActivityUserDetailRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     * @param date the date
     */
    public BaseReportRootGetEmailActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.microsoft.graph.models.extensions.DateOnly date) {
     ...
     */
    public BaseReportRootGetEmailActivityUserDetailRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final String period) {
        super(requestUrl, client, requestOptions);
