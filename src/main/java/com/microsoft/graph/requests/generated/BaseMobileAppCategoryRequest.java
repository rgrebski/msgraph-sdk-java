...
/**
 * The class for the Base Mobile App Category Request.
 */
public class BaseMobileAppCategoryRequest extends BaseRequest implements IBaseMobileAppCategoryRequest {
     ...
     */
    public BaseMobileAppCategoryRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<MobileAppCategory> responseClass) {
