...
/**
 * The class for the Base Device Enrollment Platform Restrictions Configuration Request.
 */
public class BaseDeviceEnrollmentPlatformRestrictionsConfigurationRequest extends BaseRequest implements IBaseDeviceEnrollmentPlatformRestrictionsConfigurationRequest {
     ...
     */
    public BaseDeviceEnrollmentPlatformRestrictionsConfigurationRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<DeviceEnrollmentPlatformRestrictionsConfiguration> responseClass) {
     ...
     */
     public IDeviceEnrollmentPlatformRestrictionsConfigurationRequest select(final String value) {
