...
/**
 * The class for the Base Mobile Threat Defense Connector Collection Page.
 */
public class BaseMobileThreatDefenseConnectorCollectionPage extends BaseCollectionPage<MobileThreatDefenseConnector, IMobileThreatDefenseConnectorCollectionRequestBuilder> implements IBaseMobileThreatDefenseConnectorCollectionPage {
     ...
     */
    public BaseMobileThreatDefenseConnectorCollectionPage(final BaseMobileThreatDefenseConnectorCollectionResponse response, final IMobileThreatDefenseConnectorCollectionRequestBuilder builder) {
