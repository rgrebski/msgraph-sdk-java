...
/**
 * The class for the Base Managed App Protection Target Apps Request.
 */
public class BaseManagedAppProtectionTargetAppsRequest extends BaseRequest implements IBaseManagedAppProtectionTargetAppsRequest {
     ...
     */
    public BaseManagedAppProtectionTargetAppsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
