...
/**
 * The interface for the Base Android Managed App Protection Request Builder.
 */
public interface IBaseAndroidManagedAppProtectionRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
