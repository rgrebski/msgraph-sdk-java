...
/**
 * The class for the Base Ios Managed App Registration Request Builder.
 */
public class BaseIosManagedAppRegistrationRequestBuilder extends BaseRequestBuilder implements IBaseIosManagedAppRegistrationRequestBuilder {
     ...
     */
    public BaseIosManagedAppRegistrationRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
