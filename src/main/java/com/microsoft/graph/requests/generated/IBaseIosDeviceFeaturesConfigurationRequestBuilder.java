...
/**
 * The interface for the Base Ios Device Features Configuration Request Builder.
 */
public interface IBaseIosDeviceFeaturesConfigurationRequestBuilder extends IRequestBuilder {
     ...
     * @return the IIosDeviceFeaturesConfigurationRequest instance
     */
    IIosDeviceFeaturesConfigurationRequest buildRequest(final java.util.List<? extends Option> requestOptions);
