...
/**
 * The class for the Base Default Managed App Protection Request.
 */
public class BaseDefaultManagedAppProtectionRequest extends BaseRequest implements IBaseDefaultManagedAppProtectionRequest {
     ...
     */
    public BaseDefaultManagedAppProtectionRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<DefaultManagedAppProtection> responseClass) {
