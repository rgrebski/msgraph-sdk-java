...
/**
 * The interface for the Base Device Configuration Request.
 */
public interface IBaseDeviceConfigurationRequest extends IHttpRequest {
     ...
     */
    IBaseDeviceConfigurationRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceConfigurationRequest expand(final String value);
