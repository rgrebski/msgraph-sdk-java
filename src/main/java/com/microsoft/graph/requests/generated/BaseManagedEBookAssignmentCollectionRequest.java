...
/**
 * The class for the Base Managed EBook Assignment Collection Request.
 */
public class BaseManagedEBookAssignmentCollectionRequest extends BaseCollectionRequest<BaseManagedEBookAssignmentCollectionResponse, IManagedEBookAssignmentCollectionPage> implements IBaseManagedEBookAssignmentCollectionRequest {
     ...
     */
    public BaseManagedEBookAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IManagedEBookAssignmentCollectionPage get() throws ClientException {
        final BaseManagedEBookAssignmentCollectionResponse response = send();
    ...
    public IManagedEBookAssignmentCollectionPage buildFromResponse(final BaseManagedEBookAssignmentCollectionResponse response) {
