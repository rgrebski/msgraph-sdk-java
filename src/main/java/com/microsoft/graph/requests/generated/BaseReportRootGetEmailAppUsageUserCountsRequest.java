...
public class BaseReportRootGetEmailAppUsageUserCountsRequest extends BaseRequest implements IBaseReportRootGetEmailAppUsageUserCountsRequest {
     ...
     */
    public BaseReportRootGetEmailAppUsageUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
