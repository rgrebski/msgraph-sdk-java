...
/**
 * The class for the Base Device And App Management Role Assignment Collection Request Builder.
 */
public class BaseDeviceAndAppManagementRoleAssignmentCollectionRequestBuilder extends BaseRequestBuilder implements IBaseDeviceAndAppManagementRoleAssignmentCollectionRequestBuilder {
     ...
     */
    public BaseDeviceAndAppManagementRoleAssignmentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IDeviceAndAppManagementRoleAssignmentCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IDeviceAndAppManagementRoleAssignmentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
