...
/**
 * The interface for the Base Managed App Operation Collection Request Builder.
 */
public interface IBaseManagedAppOperationCollectionRequestBuilder extends IRequestBuilder {
    ...
    IManagedAppOperationCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions);
