...
/**
 * The class for the Base Targeted Managed App Policy Assignment Collection Request.
 */
public class BaseTargetedManagedAppPolicyAssignmentCollectionRequest extends BaseCollectionRequest<BaseTargetedManagedAppPolicyAssignmentCollectionResponse, ITargetedManagedAppPolicyAssignmentCollectionPage> implements IBaseTargetedManagedAppPolicyAssignmentCollectionRequest {
     ...
     */
    public BaseTargetedManagedAppPolicyAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseTargetedManagedAppPolicyAssignmentCollectionResponse.class, ITargetedManagedAppPolicyAssignmentCollectionPage.class);
    }
    ...
    public ITargetedManagedAppPolicyAssignmentCollectionPage get() throws ClientException {
        final BaseTargetedManagedAppPolicyAssignmentCollectionResponse response = send();
    ...
    public ITargetedManagedAppPolicyAssignmentCollectionPage buildFromResponse(final BaseTargetedManagedAppPolicyAssignmentCollectionResponse response) {
