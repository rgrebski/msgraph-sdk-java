...
import com.microsoft.graph.requests.extensions.EducationUserCollectionReferenceRequestBuilder;
...
public class BaseEducationUserCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IBaseEducationUserCollectionWithReferencesRequestBuilder {
     ...
     */
    public BaseEducationUserCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IEducationUserCollectionWithReferencesRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
