...
/**
 * The class for the Base Managed Mobile App Collection Request Builder.
 */
public class BaseManagedMobileAppCollectionRequestBuilder extends BaseRequestBuilder implements IBaseManagedMobileAppCollectionRequestBuilder {
     ...
     */
    public BaseManagedMobileAppCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
