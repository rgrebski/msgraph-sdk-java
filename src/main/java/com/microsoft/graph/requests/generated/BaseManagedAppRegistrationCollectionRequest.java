...
/**
 * The class for the Base Managed App Registration Collection Request.
 */
public class BaseManagedAppRegistrationCollectionRequest extends BaseCollectionRequest<BaseManagedAppRegistrationCollectionResponse, IManagedAppRegistrationCollectionPage> implements IBaseManagedAppRegistrationCollectionRequest {
     ...
     */
    public BaseManagedAppRegistrationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IManagedAppRegistrationCollectionPage buildFromResponse(final BaseManagedAppRegistrationCollectionResponse response) {
