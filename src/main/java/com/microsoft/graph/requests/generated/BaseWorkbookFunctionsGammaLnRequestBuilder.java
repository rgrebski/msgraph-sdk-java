...
public class BaseWorkbookFunctionsGammaLnRequestBuilder extends BaseActionRequestBuilder {
     ...
     * @param x the x
     */
    public BaseWorkbookFunctionsGammaLnRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions, final com.google.gson.JsonElement x) {
     ...
     * @return the IWorkbookFunctionsGammaLnRequest instance
     */
    public IWorkbookFunctionsGammaLnRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
