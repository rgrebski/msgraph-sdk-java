...
/**
 * The class for the Base Column Link Collection Request.
 */
public class BaseColumnLinkCollectionRequest extends BaseCollectionRequest<BaseColumnLinkCollectionResponse, IColumnLinkCollectionPage> implements IBaseColumnLinkCollectionRequest {
     ...
     */
    public BaseColumnLinkCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseColumnLinkCollectionResponse.class, IColumnLinkCollectionPage.class);
    }
    ...
    public IColumnLinkCollectionPage get() throws ClientException {
        final BaseColumnLinkCollectionResponse response = send();
    ...
    public IColumnLinkCollectionPage buildFromResponse(final BaseColumnLinkCollectionResponse response) {
