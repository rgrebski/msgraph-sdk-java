...
/**
 * The class for the Base Mobile App Category Collection Request.
 */
public class BaseMobileAppCategoryCollectionRequest extends BaseCollectionRequest<BaseMobileAppCategoryCollectionResponse, IMobileAppCategoryCollectionPage> implements IBaseMobileAppCategoryCollectionRequest {
     ...
     */
    public BaseMobileAppCategoryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IMobileAppCategoryCollectionPage buildFromResponse(final BaseMobileAppCategoryCollectionResponse response) {
