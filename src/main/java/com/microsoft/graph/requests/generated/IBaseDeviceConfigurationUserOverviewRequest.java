...
/**
 * The interface for the Base Device Configuration User Overview Request.
 */
public interface IBaseDeviceConfigurationUserOverviewRequest extends IHttpRequest {
     ...
     */
    IBaseDeviceConfigurationUserOverviewRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceConfigurationUserOverviewRequest expand(final String value);
