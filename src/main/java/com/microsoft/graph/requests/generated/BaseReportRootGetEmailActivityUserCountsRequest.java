...
public class BaseReportRootGetEmailActivityUserCountsRequest extends BaseRequest implements IBaseReportRootGetEmailActivityUserCountsRequest {
     ...
     */
    public BaseReportRootGetEmailActivityUserCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
