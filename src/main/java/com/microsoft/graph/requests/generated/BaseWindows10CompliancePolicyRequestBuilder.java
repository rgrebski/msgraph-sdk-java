...
/**
 * The class for the Base Windows10Compliance Policy Request Builder.
 */
public class BaseWindows10CompliancePolicyRequestBuilder extends BaseRequestBuilder implements IBaseWindows10CompliancePolicyRequestBuilder {
     ...
     */
    public BaseWindows10CompliancePolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
     ...
     */
    public IWindows10CompliancePolicyRequest buildRequest() {
