...
public class BaseWorkbookTableColumnDataBodyRangeRequest extends BaseRequest implements IBaseWorkbookTableColumnDataBodyRangeRequest {
     ...
     */
    public BaseWorkbookTableColumnDataBodyRangeRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
