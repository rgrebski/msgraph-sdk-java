...
/**
 * The class for the Base Report Root Device Configuration User Activity Request.
 */
public class BaseReportRootDeviceConfigurationUserActivityRequest extends BaseRequest implements IBaseReportRootDeviceConfigurationUserActivityRequest {
     ...
     */
    public BaseReportRootDeviceConfigurationUserActivityRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
