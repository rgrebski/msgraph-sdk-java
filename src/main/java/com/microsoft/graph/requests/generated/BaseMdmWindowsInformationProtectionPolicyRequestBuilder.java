...
/**
 * The class for the Base Mdm Windows Information Protection Policy Request Builder.
 */
public class BaseMdmWindowsInformationProtectionPolicyRequestBuilder extends BaseRequestBuilder implements IBaseMdmWindowsInformationProtectionPolicyRequestBuilder {
     ...
     */
    public BaseMdmWindowsInformationProtectionPolicyRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
