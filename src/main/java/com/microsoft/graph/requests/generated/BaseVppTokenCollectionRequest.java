...
/**
 * The class for the Base Vpp Token Collection Request.
 */
public class BaseVppTokenCollectionRequest extends BaseCollectionRequest<BaseVppTokenCollectionResponse, IVppTokenCollectionPage> implements IBaseVppTokenCollectionRequest {
     ...
     */
    public BaseVppTokenCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IVppTokenCollectionPage get() throws ClientException {
        final BaseVppTokenCollectionResponse response = send();
    ...
    public IVppTokenCollectionPage buildFromResponse(final BaseVppTokenCollectionResponse response) {
