...
/**
 * The class for the Base Managed App Status Collection Request Builder.
 */
public class BaseManagedAppStatusCollectionRequestBuilder extends BaseRequestBuilder implements IBaseManagedAppStatusCollectionRequestBuilder {
     ...
     */
    public BaseManagedAppStatusCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IManagedAppStatusCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IManagedAppStatusCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
