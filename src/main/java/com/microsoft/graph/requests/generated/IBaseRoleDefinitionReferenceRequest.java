...
/**
 * The interface for the Base Role Definition Reference Request.
 */
public interface IBaseRoleDefinitionReferenceRequest extends IHttpRequest {
     ...
     */
    IBaseRoleDefinitionReferenceRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseRoleDefinitionReferenceRequest expand(final String value);
