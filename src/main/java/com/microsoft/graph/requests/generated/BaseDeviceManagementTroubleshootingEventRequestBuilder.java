...
/**
 * The class for the Base Device Management Troubleshooting Event Request Builder.
 */
public class BaseDeviceManagementTroubleshootingEventRequestBuilder extends BaseRequestBuilder implements IBaseDeviceManagementTroubleshootingEventRequestBuilder {
     ...
     */
    public BaseDeviceManagementTroubleshootingEventRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
