...
public class BaseReportRootGetEmailActivityCountsRequest extends BaseRequest implements IBaseReportRootGetEmailActivityCountsRequest {
     ...
     */
    public BaseReportRootGetEmailActivityCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
