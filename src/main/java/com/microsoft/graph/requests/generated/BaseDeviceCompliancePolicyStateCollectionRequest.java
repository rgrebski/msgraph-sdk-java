...
/**
 * The class for the Base Device Compliance Policy State Collection Request.
 */
public class BaseDeviceCompliancePolicyStateCollectionRequest extends BaseCollectionRequest<BaseDeviceCompliancePolicyStateCollectionResponse, IDeviceCompliancePolicyStateCollectionPage> implements IBaseDeviceCompliancePolicyStateCollectionRequest {
     ...
     */
    public BaseDeviceCompliancePolicyStateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceCompliancePolicyStateCollectionPage get() throws ClientException {
        final BaseDeviceCompliancePolicyStateCollectionResponse response = send();
    ...
    public IDeviceCompliancePolicyStateCollectionPage buildFromResponse(final BaseDeviceCompliancePolicyStateCollectionResponse response) {
