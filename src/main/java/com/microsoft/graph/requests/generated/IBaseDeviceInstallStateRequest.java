...
/**
 * The interface for the Base Device Install State Request.
 */
public interface IBaseDeviceInstallStateRequest extends IHttpRequest {
     ...
     */
    void get(final ICallback<DeviceInstallState> callback);
     ...
     * @param callback the callback to be called after success or failure
     */
    void patch(final DeviceInstallState sourceDeviceInstallState, final ICallback<DeviceInstallState> callback);
     ...
     */
    IBaseDeviceInstallStateRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseDeviceInstallStateRequest expand(final String value);
