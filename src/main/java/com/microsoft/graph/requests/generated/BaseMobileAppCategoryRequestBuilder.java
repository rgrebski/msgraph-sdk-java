...
/**
 * The class for the Base Mobile App Category Request Builder.
 */
public class BaseMobileAppCategoryRequestBuilder extends BaseRequestBuilder implements IBaseMobileAppCategoryRequestBuilder {
     ...
     */
    public BaseMobileAppCategoryRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
