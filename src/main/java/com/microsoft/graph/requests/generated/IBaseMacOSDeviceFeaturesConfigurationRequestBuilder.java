...
/**
 * The interface for the Base Mac OSDevice Features Configuration Request Builder.
 */
public interface IBaseMacOSDeviceFeaturesConfigurationRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
