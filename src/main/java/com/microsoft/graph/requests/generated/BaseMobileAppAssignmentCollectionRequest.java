...
/**
 * The class for the Base Mobile App Assignment Collection Request.
 */
public class BaseMobileAppAssignmentCollectionRequest extends BaseCollectionRequest<BaseMobileAppAssignmentCollectionResponse, IMobileAppAssignmentCollectionPage> implements IBaseMobileAppAssignmentCollectionRequest {
     ...
     */
    public BaseMobileAppAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IMobileAppAssignmentCollectionPage get() throws ClientException {
        final BaseMobileAppAssignmentCollectionResponse response = send();
    ...
    public IMobileAppAssignmentCollectionPage buildFromResponse(final BaseMobileAppAssignmentCollectionResponse response) {
