...
/**
 * The interface for the Base Mobile Lob App Request.
 */
public interface IBaseMobileLobAppRequest extends IHttpRequest {
     ...
     */
    IBaseMobileLobAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseMobileLobAppRequest expand(final String value);
