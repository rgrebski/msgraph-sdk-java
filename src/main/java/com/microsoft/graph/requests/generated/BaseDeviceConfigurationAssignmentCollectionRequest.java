...
/**
 * The class for the Base Device Configuration Assignment Collection Request.
 */
public class BaseDeviceConfigurationAssignmentCollectionRequest extends BaseCollectionRequest<BaseDeviceConfigurationAssignmentCollectionResponse, IDeviceConfigurationAssignmentCollectionPage> implements IBaseDeviceConfigurationAssignmentCollectionRequest {
     ...
     */
    public BaseDeviceConfigurationAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseDeviceConfigurationAssignmentCollectionResponse.class, IDeviceConfigurationAssignmentCollectionPage.class);
    }
    ...
    public IDeviceConfigurationAssignmentCollectionPage get() throws ClientException {
        final BaseDeviceConfigurationAssignmentCollectionResponse response = send();
    ...
    public IDeviceConfigurationAssignmentCollectionPage buildFromResponse(final BaseDeviceConfigurationAssignmentCollectionResponse response) {
