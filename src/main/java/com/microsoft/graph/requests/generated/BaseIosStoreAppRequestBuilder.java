...
/**
 * The class for the Base Ios Store App Request Builder.
 */
public class BaseIosStoreAppRequestBuilder extends BaseRequestBuilder implements IBaseIosStoreAppRequestBuilder {
     ...
     */
    public BaseIosStoreAppRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
