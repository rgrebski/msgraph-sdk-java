...
/**
 * The class for the Base Managed App Status Request.
 */
public class BaseManagedAppStatusRequest extends BaseRequest implements IBaseManagedAppStatusRequest {
     ...
     */
    public BaseManagedAppStatusRequest(final String requestUrl,
