...
/**
 * The class for the Base Device Install State Collection Request.
 */
public class BaseDeviceInstallStateCollectionRequest extends BaseCollectionRequest<BaseDeviceInstallStateCollectionResponse, IDeviceInstallStateCollectionPage> implements IBaseDeviceInstallStateCollectionRequest {
     ...
     */
    public BaseDeviceInstallStateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceInstallStateCollectionPage get() throws ClientException {
        final BaseDeviceInstallStateCollectionResponse response = send();
    ...
    public IDeviceInstallStateCollectionPage buildFromResponse(final BaseDeviceInstallStateCollectionResponse response) {
