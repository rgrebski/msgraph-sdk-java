...
/**
 * The class for the Base Setting State Device Summary Collection Request.
 */
public class BaseSettingStateDeviceSummaryCollectionRequest extends BaseCollectionRequest<BaseSettingStateDeviceSummaryCollectionResponse, ISettingStateDeviceSummaryCollectionPage> implements IBaseSettingStateDeviceSummaryCollectionRequest {
     ...
     */
    public BaseSettingStateDeviceSummaryCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public ISettingStateDeviceSummaryCollectionPage get() throws ClientException {
        final BaseSettingStateDeviceSummaryCollectionResponse response = send();
    ...
    public ISettingStateDeviceSummaryCollectionPage buildFromResponse(final BaseSettingStateDeviceSummaryCollectionResponse response) {
