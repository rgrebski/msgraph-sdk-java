...
/**
 * The class for the Base Device Configuration Device Status Request.
 */
public class BaseDeviceConfigurationDeviceStatusRequest extends BaseRequest implements IBaseDeviceConfigurationDeviceStatusRequest {
     ...
     */
    public BaseDeviceConfigurationDeviceStatusRequest(final String requestUrl,
            final IBaseClient client,
            final java.util.List<? extends Option> requestOptions,
            final Class<DeviceConfigurationDeviceStatus> responseClass) {
