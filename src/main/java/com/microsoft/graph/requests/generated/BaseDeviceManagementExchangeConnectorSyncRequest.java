...
/**
 * The class for the Base Device Management Exchange Connector Sync Request.
 */
public class BaseDeviceManagementExchangeConnectorSyncRequest extends BaseRequest implements IBaseDeviceManagementExchangeConnectorSyncRequest {
     ...
     */
    public BaseDeviceManagementExchangeConnectorSyncRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
