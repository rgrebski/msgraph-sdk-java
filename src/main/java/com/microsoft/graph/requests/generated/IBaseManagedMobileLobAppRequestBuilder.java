...
/**
 * The interface for the Base Managed Mobile Lob App Request Builder.
 */
public interface IBaseManagedMobileLobAppRequestBuilder extends IRequestBuilder {
     ...
     * @return the IManagedMobileLobAppRequest instance
     */
    IManagedMobileLobAppRequest buildRequest(final java.util.List<? extends Option> requestOptions);
