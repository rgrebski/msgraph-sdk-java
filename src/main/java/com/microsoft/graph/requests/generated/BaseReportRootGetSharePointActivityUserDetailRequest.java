...
public class BaseReportRootGetSharePointActivityUserDetailRequest extends BaseRequest implements IBaseReportRootGetSharePointActivityUserDetailRequest {
     ...
     */
    public BaseReportRootGetSharePointActivityUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
