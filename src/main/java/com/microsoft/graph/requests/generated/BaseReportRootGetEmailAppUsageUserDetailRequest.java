...
public class BaseReportRootGetEmailAppUsageUserDetailRequest extends BaseRequest implements IBaseReportRootGetEmailAppUsageUserDetailRequest {
     ...
     */
    public BaseReportRootGetEmailAppUsageUserDetailRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
