...
/**
 * The class for the Base Device And App Management Role Assignment Collection Request.
 */
public class BaseDeviceAndAppManagementRoleAssignmentCollectionRequest extends BaseCollectionRequest<BaseDeviceAndAppManagementRoleAssignmentCollectionResponse, IDeviceAndAppManagementRoleAssignmentCollectionPage> implements IBaseDeviceAndAppManagementRoleAssignmentCollectionRequest {
     ...
     */
    public BaseDeviceAndAppManagementRoleAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IDeviceAndAppManagementRoleAssignmentCollectionPage get() throws ClientException {
        final BaseDeviceAndAppManagementRoleAssignmentCollectionResponse response = send();
    ...
    public IDeviceAndAppManagementRoleAssignmentCollectionPage buildFromResponse(final BaseDeviceAndAppManagementRoleAssignmentCollectionResponse response) {
