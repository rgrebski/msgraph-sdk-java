...
/**
 * The class for the Base Managed Device Retire Request Builder.
 */
public class BaseManagedDeviceRetireRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseManagedDeviceRetireRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
