...
/**
 * The class for the Base Resource Operation Collection Request.
 */
public class BaseResourceOperationCollectionRequest extends BaseCollectionRequest<BaseResourceOperationCollectionResponse, IResourceOperationCollectionPage> implements IBaseResourceOperationCollectionRequest {
     ...
     */
    public BaseResourceOperationCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public IResourceOperationCollectionPage get() throws ClientException {
        final BaseResourceOperationCollectionResponse response = send();
    ...
    public IResourceOperationCollectionPage buildFromResponse(final BaseResourceOperationCollectionResponse response) {
