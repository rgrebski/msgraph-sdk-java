...
public class BaseReportRootGetMailboxUsageMailboxCountsRequest extends BaseRequest implements IBaseReportRootGetMailboxUsageMailboxCountsRequest {
     ...
     */
    public BaseReportRootGetMailboxUsageMailboxCountsRequest(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
