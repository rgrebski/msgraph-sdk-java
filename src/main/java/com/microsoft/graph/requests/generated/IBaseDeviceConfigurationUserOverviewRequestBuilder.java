...
/**
 * The interface for the Base Device Configuration User Overview Request Builder.
 */
public interface IBaseDeviceConfigurationUserOverviewRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
