...
/**
 * The interface for the Base Android Store App Request.
 */
public interface IBaseAndroidStoreAppRequest extends IHttpRequest {
     ...
     */
    IBaseAndroidStoreAppRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseAndroidStoreAppRequest expand(final String value);
