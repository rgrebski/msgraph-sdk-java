...
/**
 * The interface for the Base Report Root Device Configuration User Activity Request.
 */
public interface IBaseReportRootDeviceConfigurationUserActivityRequest {
     ...
     */
    IReportRootDeviceConfigurationUserActivityRequest select(final String value);
     ...
     * @return the updated request
     */
    IReportRootDeviceConfigurationUserActivityRequest expand(final String value);
