...
/**
 * The class for the Base Device And App Management Role Assignment Request Builder.
 */
public class BaseDeviceAndAppManagementRoleAssignmentRequestBuilder extends BaseRequestBuilder implements IBaseDeviceAndAppManagementRoleAssignmentRequestBuilder {
     ...
     */
    public BaseDeviceAndAppManagementRoleAssignmentRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
