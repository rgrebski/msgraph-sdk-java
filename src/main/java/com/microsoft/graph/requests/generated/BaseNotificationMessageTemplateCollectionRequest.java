...
/**
 * The class for the Base Notification Message Template Collection Request.
 */
public class BaseNotificationMessageTemplateCollectionRequest extends BaseCollectionRequest<BaseNotificationMessageTemplateCollectionResponse, INotificationMessageTemplateCollectionPage> implements IBaseNotificationMessageTemplateCollectionRequest {
     ...
     */
    public BaseNotificationMessageTemplateCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
    ...
    public INotificationMessageTemplateCollectionPage get() throws ClientException {
        final BaseNotificationMessageTemplateCollectionResponse response = send();
    ...
    public INotificationMessageTemplateCollectionPage buildFromResponse(final BaseNotificationMessageTemplateCollectionResponse response) {
