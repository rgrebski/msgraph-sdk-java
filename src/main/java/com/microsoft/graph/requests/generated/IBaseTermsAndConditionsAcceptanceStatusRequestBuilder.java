...
/**
 * The interface for the Base Terms And Conditions Acceptance Status Request Builder.
 */
public interface IBaseTermsAndConditionsAcceptanceStatusRequestBuilder extends IRequestBuilder {
    /**
     * Creates the request
     *
