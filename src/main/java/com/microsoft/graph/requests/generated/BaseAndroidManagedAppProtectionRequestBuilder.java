...
/**
 * The class for the Base Android Managed App Protection Request Builder.
 */
public class BaseAndroidManagedAppProtectionRequestBuilder extends BaseRequestBuilder implements IBaseAndroidManagedAppProtectionRequestBuilder {
     ...
     */
    public BaseAndroidManagedAppProtectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
