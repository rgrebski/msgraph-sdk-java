...
/**
 * The class for the Base Enrollment Configuration Assignment Collection Request.
 */
public class BaseEnrollmentConfigurationAssignmentCollectionRequest extends BaseCollectionRequest<BaseEnrollmentConfigurationAssignmentCollectionResponse, IEnrollmentConfigurationAssignmentCollectionPage> implements IBaseEnrollmentConfigurationAssignmentCollectionRequest {
     ...
     */
    public BaseEnrollmentConfigurationAssignmentCollectionRequest(final String requestUrl, IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseEnrollmentConfigurationAssignmentCollectionResponse.class, IEnrollmentConfigurationAssignmentCollectionPage.class);
    }
    ...
    public IEnrollmentConfigurationAssignmentCollectionPage get() throws ClientException {
        final BaseEnrollmentConfigurationAssignmentCollectionResponse response = send();
    ...
    public IEnrollmentConfigurationAssignmentCollectionPage buildFromResponse(final BaseEnrollmentConfigurationAssignmentCollectionResponse response) {
