...
/**
 * The class for the Base Role Assignment Collection Request Builder.
 */
public class BaseRoleAssignmentCollectionRequestBuilder extends BaseRequestBuilder implements IBaseRoleAssignmentCollectionRequestBuilder {
     ...
     */
    public BaseRoleAssignmentCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final java.util.List<? extends Option> requestOptions) {
        super(requestUrl, client, requestOptions);
    }

    public IRoleAssignmentCollectionRequest buildRequest() {
        return buildRequest(getOptions());
    }

    public IRoleAssignmentCollectionRequest buildRequest(final java.util.List<? extends Option> requestOptions) {
