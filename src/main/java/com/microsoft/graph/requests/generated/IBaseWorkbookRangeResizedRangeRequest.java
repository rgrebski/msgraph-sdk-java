...
/**
 * The interface for the Base Workbook Range Resized Range Request.
 */
public interface IBaseWorkbookRangeResizedRangeRequest {
     ...
     */
    IWorkbookRangeResizedRangeRequest select(final String value);
     ...
     * @return the updated request
     */
    IWorkbookRangeResizedRangeRequest expand(final String value);
