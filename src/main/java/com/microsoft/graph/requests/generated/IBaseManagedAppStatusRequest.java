...
/**
 * The interface for the Base Managed App Status Request.
 */
public interface IBaseManagedAppStatusRequest extends IHttpRequest {
     ...
     */
    IBaseManagedAppStatusRequest select(final String value);
     ...
     * @return the updated request
     */
    IBaseManagedAppStatusRequest expand(final String value);
